                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="catatan" class="form-control" rows="3" 
                                  placeholder="Tambahkan alasan atau catatan..."></textarea>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Info:</strong>
                        <ul class="mb-0 mt-2">
                            <li><strong>Approve:</strong> Barang akan masuk ke stok & status PO jadi "Approved"</li>
                            <li><strong>Reject:</strong> Barang tidak masuk stok, akan generate laporan penolakan</li>
                        </ul>
                    </div>
                </div>
            </div>
